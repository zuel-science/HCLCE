...
def train():
    ...
    for epoch in range(args.nb_epochs):
        ...
        if loss < best:
            ...
            best_t = epoch
            cnt_wait = 0
            torch.save(model.state_dict(), 'HCLCE-main/HCLCE_'+own_str+'.pkl')
        else:
            cnt_wait += 1
    ...
    model.load_state_dict(torch.load('HCLCE-main/HCLCE_'+own_str+'.pkl'))
    model.eval()
    os.remove('HCLCE-main/HCLCE_'+own_str+'.pkl')
